      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl p-8 mb-12">
            <h2 className="text-2xl font-bold mb-4">Welcome to curate.ae</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <h3 className="text-xl font-semibold">Conditions of Sale</h3>
              </div>
            </a>
          </div>

          {/* CONDITIONS OF USE */}
          <section id="conditions-of-use" className="mb-16">
            <div className="bg-muted/50 rounded-lg p-8">
              ...
              <div className="mb-8">
                ...
                <div className="prose max-w-none text-muted-foreground">
                  <p>We understand how sharing your personal information is rather a sensitive matter that shall be dealt with carefully and wisely.</p>
              ...
              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Intellectual Property Rights and Claims</h3>
                <div className="prose max-w-none text-muted-foreground">
                  <p>All content, including but not limited to texts, graphics, logos, button icons, images, audio clips, digital downloads, and data compilations, that is included in or made available through the Site is the exclusive property of the Company and/or the content providers, and is protected by the United Arab Emirates and international copyright, author's rights, and database rights, trademark, patent, trade secret and any other applicable intellectual property or property right laws.</p>
                  <p>Without our express prior written consent, you may not extract or re-utilize or regenerate any of the information used or displayed on the Site.</p>
                  <p>As we affirm the importance of the protection and respect of intellectual rights against any infringement by others, if you believe that your intellectual property rights or any intellectual property rights made available or displayed on our Site have been used in a way that rises concerns of infringement, please contact our Customer Services.</p>
                </div>
              </div>

              {/* Licence */}
              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Licence</h3>
                <div className="prose max-w-none text-muted-foreground">
                  <p>Subject to the Terms and Conditions provided herein and your compliance with our Services, the Company shall grant you a limited, revocable, non-exclusive, non-transferable, non-sublicensable, non-commercial licence to access, and use and browse this Site.</p>
                  <p>Your use of the Site shall be limited only to a certain extent as permitted by our regulations and applicable law. You further understand that you shall not be entitled to the following:</p>
              ...
              <div className="mb-8">
                ...
                <div className="prose max-w-none text-muted-foreground">
                  <p>By granting you access to our Site, you shall represent and warrant the following:</p>
                  <ul className="list-disc pl-6 mt-4 space-y-2">
          ...
          {/* CONDITIONS OF SALE */}
          <section id="conditions-of-sale" className="mb-16">
            <div className="bg-muted/50 rounded-lg p-8">
              <h2 className="text-3xl font-bold mb-8 flex items-center space-x-3">
              ...
              {/* Online Marketplace */}
              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Online Marketplace</h3>
                <div className="prose max-w-none text-muted-foreground">
                  <p>The Company shall offer you an online marketplace, an e-commerce Site, whereby you are connected with vendors (the "Vendor(s)").</p>
                  <p>Transactions made using our Site may allow us and other Vendors to list and sell products, as Vendors may operate stores, provide services, or sell product lines on our Site.</p>
                  ...
                  <p>By using our Site, you may be asked to create or log-in to your own account that shall have a valid payment method associated with it. You shall claim full responsibility for maintaining the confidentiality of your account information and for the activities that occur under your account.</p>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="prose max-w-none text-muted-foreground">
                  <p>When you place an order with us (the "Order"), we will confirm your order by sending you a confirmation email containing the Order receipt. Where applicable, Orders will include delivery fees and any applicable tax (e.g., goods and services tax, value-added tax, etc.).</p>
                  <p>Some of our Services require a minimum order value (the "MOV") before an Order can be placed and delivered to you. Where an applicable Order fails to meet the MOV, you will have the option of paying the difference to meet the MOV or to add more goods or products to your Order.</p>
                  <p>When placing an Order on our Site, you shall follow the onscreen instructions provided. You may be required to provide additional details for us to complete your Order, and you shall review and confirm that all the information you provide, including the amounts, delivery details, personal details, payment information, and voucher codes (if applicable) is true, accurate and complete before you place your Order.</p>
                  <p>An Order is successfully placed when you receive an email confirmation containing your Order receipt from us.</p>
                </div>
              </div>

              {/* Payments and Prices */}
              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Payments and Prices</h3>
                <div className="prose max-w-none text-muted-foreground">
                  <p>Prices quoted on the Site shall be displayed in the national currency of the United Arab Emirates, and subject to applicable tax. Prices on the Site may vary from the prices offered by our Vendors, and you accept that offers offered by our Vendors. The prices displayed on our Site may include or exclude VAT or such equivalent tax.</p>
                  <p>You can choose to pay for an Order using any of the different payment methods offered on the Site including:</p>
                  <ul className="list-disc pl-6 mt-4 space-y-2">
              ...
              {/* Delivery of Goods */}
              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Delivery of Goods</h3>
                <div className="prose max-w-none text-muted-foreground">
                  <p>As we are always seeking to bestow you with the best shopping experience, we shall provide you with professional delivery services in the United Arab Emirates.</p>
                  <p>Delivery of your goods shall be handled by a third-party delivery courier to the address information you provide us with.</p>
                  <p>An estimated delivery time will be provided to you via an email confirmation. However, you agree that due to major unforeseeable operational disruptions owing to without limitation to shortage of raw materials, workers, strikes, traffic, lockdowns, delay, official control measures and events of force majeure in delivery or non-delivery by the delivery carrier may occur, and we shall not bear any responsibility or liability thereof.</p>
                </div>
              </div>

              {/* Discounts and Promotions */}
              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Discounts and Promotions and Vouchers</h3>
                <div className="prose max-w-none text-muted-foreground">
                  <p>We may run occasionally marketing and promotional campaigns where voucher codes, discounts, promotions may be offered to be used on our Site. Promotional offers or vouchers are subject to validity periods, periods, and in some they may only be used once.</p>
                  <p>When used in conjunction with other promotional means or offers, vouchers may not be valid, and unless otherwise stated, discounts and promotions and vouchers can only be used on our Site.</p>
                  <p>Vouchers cannot be replaced with cash, and we shall reserve the right to void, discontinue or reject the use of any Voucher without prior notice when deemed reasonably fit.</p>
                </div>
              </div>
            </div>
          </section>
