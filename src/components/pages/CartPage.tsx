                      ...
                      <Card key={item.id} className="overflow-hidden">
                        <CardContent className="p-4">
                          <div className="flex gap-4">
                            <Link to={`/product/${item.productId}`} className="relative">
                              <img
                                src={item.image}
                                alt={item.title}
                                className="w-20 h-28 object-cover rounded-lg hover:opacity-90 transition-opacity"
                              />
                              {!item.inStock && (
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      ...
                      {currentStep === 1 && <Truck className="h-5 w-5" />}
